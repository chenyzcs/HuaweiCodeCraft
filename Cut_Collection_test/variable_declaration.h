...
// 最小费最大流算法
extern std::vector<std::vector<float>>  Max_Flow_Min_Cost(std::vector<netNode_index> &assign_host_nodes, std::vector<std::vector<netNode_index>> &bestcnn);
...
// GA算法
extern int gen(float *min_cost, std::vector<std::vector<netNode_index>> &bestcnn);
extern std::vector<netNode_index> exchange_host_list(float *min_cost, std::vector<std::vector<netNode_index>> &bestcnn);
