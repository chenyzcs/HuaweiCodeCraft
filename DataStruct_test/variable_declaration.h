...
// 边弧图
extern arc_bandwidth arcBandWidth[CONSUME_NODE_MAXSIZE];		// 边弧带宽容量
extern arc_rentcost arcRentCost[CONSUME_NODE_MAXSIZE];			// 边弧带宽租金
...
extern void Init_netNode(netNode_index (*bw)[NET_NODE_MAXSIZE], 
	netNode_index (*rc)[NET_NODE_MAXSIZE]);		// 初始化1000*1000的网络节点图
