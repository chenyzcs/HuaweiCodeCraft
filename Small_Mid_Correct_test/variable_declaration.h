...
extern std::vector<std::vector<int>>  Max_Flow_Min_Cost_big(std::vector<netNode_index> &assign_host_nodes);
...
// 搜索
extern std::vector<std::vector<netNode_index>> search();
//extern void Cij_search(int i, int j, std::vector<int> &r, int num, std::vector<std::vector<int>> & result, int *min, std::vector<int> &netnodes);
extern void Cij_search(int i, int j, std::vector<int> &r, int num, std::vector<int> & result, int *min, std::vector<int> &netnodes);
extern void Cij_search_loop(int size_i, int size_j, std::vector<int> & result, int *min, std::vector<int> &netnodes, std::vector<std::vector<int>> &ret_path);
extern void Cij_search_loop_big(int size_i, int size_j, std::vector<int> & result, int *min, std::vector<int> &netnodes, std::vector<int> &first_half_consume, std::vector<std::vector<int>> &path, std::vector<int> & _host, std::vector<int> &static_point);
extern void Cij_search_loop_big_rand(int size_i, int size_j, std::vector<int> & result, int *min, std::vector<int> &netnodes, std::vector<int> &first_half_consume, std::vector<std::vector<int>> &ret_path);
extern void Cij_search_loop_big_sun(int size_i, int size_j, std::vector<int> & result, int *min, std::vector<int> &netnodes, std::vector<int> &first_half_consume, std::vector<std::vector<int>> &path, std::vector<int> & _host, std::vector<int> &static_point);
extern void Cij_search_loop_big_host_loc(int size_i, int size_j, std::vector<int> & result, int *min, std::vector<int> &netnodes, std::vector<int> &first_half_consume, std::vector<std::vector<int>> &path, std::vector<int> & _host, std::vector<int> &static_point);


extern std::vector<std::vector<int>>  DFS_MCMF(std::vector<netNode_index> &assign_host_nodes);
extern std::vector<std::vector<int>> DFS_v(int v0, int tag, std::vector<std::vector<netNode_index>> &G_adj, std::vector<std::vector<netNode_index>> &rc, std::vector<std::vector<netNode_index>> &bw);
extern std::vector<std::vector<int>> DFS_v_more(int v0, int tag, std::vector<std::vector<netNode_index>> &G_adj, std::vector<std::vector<netNode_index>> &rc, std::vector<std::vector<netNode_index>> &bw);
// 定时器
extern unsigned long print_time();

// 小图搜索
//extern std::vector<std::vector<int>> search_small();


// ZKW

extern int costflow(std::vector<std::vector<netNode_index>> &G_adj, std::vector<std::vector<netNode_index>> &rc, std::vector<std::vector<netNode_index>> &bw, int max_flow);
extern bool modlabel(std::vector<std::vector<netNode_index>> &G_adj, std::vector<std::vector<netNode_index>> &rc, std::vector<std::vector<netNode_index>> &bw);
extern int aug(int u, int f, std::vector<std::vector<netNode_index>> &G_adj, std::vector<std::vector<netNode_index>> &rc, std::vector<std::vector<netNode_index>> &bw);
extern int zkw_mcmf(std::vector<netNode_index> &assign_host_nodes);
